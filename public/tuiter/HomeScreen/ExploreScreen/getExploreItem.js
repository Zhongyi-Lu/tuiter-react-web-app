const getExploreItem = (item) => {
    return (`
        <div class="wd-home-sub-container-b">
        <div class="wd-home-image-box">
            <img class="wd-home-small-image"
                 src="${item.icon}">
        </div>


        <div class="wd-home-detail-tuit">
            <div class="wd-home-sub-box-b">
                <div>
                    ...
                    <div class="wd-home-message-body">
                        ${item.tuitBody}
                    </div>
                </div>
        ...
        `<div 
            ...
            <div class="wd-home-counter-container">
                <div class="wd-home-counter-box">
                    ...
                    <div class="wd-home-counter-text">
                        ${item.reply}
                    </div>
                </div>
